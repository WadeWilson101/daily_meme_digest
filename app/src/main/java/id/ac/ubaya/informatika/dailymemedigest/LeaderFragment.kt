...
class LeaderFragment() : Fragment() {
    ...
    var users: ArrayList<Users> = ArrayList() // fungsi untuk menyimpan array, dan di pasingkan ke homeadapter
...
//        }
        ...
        val url = "https://ubaya.fun/native/160420152/memes_api/get_all_user.php"
        var stringRequest = StringRequest(Request.Method.GET, url,
            Response.Listener<String> {
                ...
                if (obj.getString("result") == "OK"){
                    ...
                    val data_likes = obj.getJSONArray("likes")
                    // for each JSON Object in the json Array..
                    for (i in 0 until data.length() ){
                        // retrieve the JSON object
                        val playObj = data.getJSONObject(i)
                        val likesObj = data_likes.getJSONObject(i)
                        ...
                        val user = Users(
                            ...
                            likesObj.getInt("tot_likes"),
                            playObj.getInt("privacy_set"),
                    ...
                    Log.d("playlists", users.toString())
                }
    ...
    fun updateList(){
        ...
        view?.leaderView?.let {
            ...
            it.adapter = LeaderAdapter(users)
