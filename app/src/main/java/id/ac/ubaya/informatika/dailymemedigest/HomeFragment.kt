 ...
 */
class HomeFragment(val usr_id: String) : Fragment() {
...
//        }
        ...
        val url = "https://ubaya.fun/native/160420152/memes_api/get_memes.php"
    ...
    fun updateList(){
        ...
        view?.homeView?.let {
            ...
            it.adapter = HomeAdapter(homes,user_id!!) // passing user_id (4)
